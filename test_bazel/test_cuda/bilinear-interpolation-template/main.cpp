...
#include "test_bazel/test_cuda/bilinear-interpolation-template/preprocess.hpp"
#include "test_bazel/test_cuda/bilinear-interpolation-template/timer.hpp"
...
int main() {
  ...
  string file_path = "test_bazel/test_cuda/bilinear-interpolation-template/data/fox.png";
   ...
   * 比如说，后面的课程会讲到的某些TensorRT
   * plugin的核函数，对于输入tensor是FP32, FP16, INT8都会做类似的处理
